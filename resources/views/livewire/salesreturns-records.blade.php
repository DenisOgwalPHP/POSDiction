    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Sales Returns Records</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/Dashboard">Home</a></li>
                            <li class="breadcrumb-item active">Sales Returns Records</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info" wire:ignore>
                            <div class="card-header">
                                <h3 class="card-title">Sales Returns Records Listing</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($registeredreturns as $registeredreturn)
                                            <tr>
                                                ...
                                                <td>{{ $registeredreturn->returnedproduct->Origin}}</td>
                                                <td>{{ $registeredreturn->Quantity}}</td>
                                                <td>{{ $registeredreturn->SalesRefer}}</td>
                                                <td>{{ $registeredreturn->returnclient->AccountName}}</td>
