    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Damaged Asset Form</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/admin/Dashboard">Home</a></li>
                            <li class="breadcrumb-item active">Damaged Asset Form</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Input Damaged Asset Details</h3>
                            </div>
                            <div class="card-body">

                                <form class="form-horizontal" wire:submit.prevent="AddAssetUsed">
                                    @csrf
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="integer" class="form-control" name="UnitCost"
                                            placeholder="Unit Cost" wire:model="UnitCost" readonly>
                                        @error('UnitCost')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-md-6" wire:ignore>
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Damaged Assets Listing</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                       @foreach ($registeredItems as $registeredItem)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('Damaged-Assets-Register', ['slug' => $registeredItem->id]) }}"
                                                ...
                                                <td> <a href="#" class="btn btn-block btn-outline-danger"
                                                        onclick="confirm('Are you sure, You want to delete this Damaged Asset Listing') || event.stopImmediatePropagation()"
                                                        wire:click.prevent="deleteItemUsage({{ $registeredItem->id }})">
