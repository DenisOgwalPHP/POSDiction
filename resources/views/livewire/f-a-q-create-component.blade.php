    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>FAQs Details Editor </h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/admin/Dashboard">Home</a></li>
                            <li class="breadcrumb-item active">FAQ Editors</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="saveFaqs">
                                @csrf
                                <div class="form-group" wire:ignore>
                                    <textarea id="description" name="description" wire:model="description" x-ref="summernoteTextarea"></textarea>
                                    @error('description')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#description').summernote({
                Placeholder: 'Please add your FAQs',
                tabsize: 2,
                minHeight: 250,
                toolbar: [
                    ['style', ['style']],
