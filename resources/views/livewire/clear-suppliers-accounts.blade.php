    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Clear Suppliers</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/Dashboard">Home</a></li>
                            <li class="breadcrumb-item active">Clear Suppliers</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" class="form-horizontal" enctype="multipart/form-data"
                                    wire:submit.prevent="ClearSupplier">
                                    @csrf
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control select" style="width: 80%;" name="supplierid"
                    ...
                    <div class="col-md-6" wire:ignore>
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Supplier Clearance Transaction Listing</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($registeredclearance as $registeredclear)
                                            <tr>
                                                ...
                                                <td>{{ $registeredclear->clearedsupplier->AccountName }}</td>
                                                <td>{{ $registeredclear->TransactionType }}</td>
