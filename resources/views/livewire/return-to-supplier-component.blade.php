            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Input Returned Product Details</h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6" wire:ignore>
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Products Returned to Supplier Listing</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($registeredreturns as $registeredreturn)
                                            <tr>
                                                ...
                                                <td>{{ $registeredreturn->Purchasedproduct->Units }}</td>
